...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class SetMaterialVideoTexture : ComponentAction<Renderer>
    {
        ...
        [Tooltip("The VideoPlayer component to use as the texture source.")]
        ...
        void DoSetMaterialTexture()
        {
            ...
            // Ensure the VideoPlayer has a valid texture
            if (video.texture == null)
            {
                LogError("VideoPlayer doesn't have a valid texture!");
                return;
            }
